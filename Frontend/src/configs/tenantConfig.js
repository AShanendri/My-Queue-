...
export const tenantLabels = {
  default: {
    ...
    selectedEntityLabel: "Selected Branch",
    entitySearchPlaceholder: "Type branch name...",
    serviceSearchPlaceholder: "Search services...",
    serviceSelectionTitle: "Available Services",
    serviceSelectionDescription: "All services offered by this organization across all branches.",
    availableEntitiesText: "Available branches for this tenant:",
  },
  bank: {
    entityPlural: "Counters",
    entitySingular: "Counter",
    services: "Services",
    bookToken: "Get Token",
    queueStatus: "Queue Status",
    notifications: "Notifications",
    myBooking: "My Booking",
    bookingTypeLabel: "Booking Type",
    selectedEntityLabel: "Selected Counter",
    entitySearchPlaceholder: "Search counters...",
    serviceSearchPlaceholder: "Search services...",
    serviceSelectionTitle: "Available Services",
    serviceSelectionDescription: "All services offered by this organization across all counters.",
    availableEntitiesText: "Available counters for this tenant:",
  },
  hospital: {
    entityPlural: "Wards",
    entitySingular: "Ward",
    ...
    myBooking: "My Booking",
    bookingTypeLabel: "Booking Type",
    selectedEntityLabel: "Selected Ward",
    entitySearchPlaceholder: "Search wards...",
    serviceSearchPlaceholder: "Search services...",
    serviceSelectionTitle: "Available Services",
    serviceSelectionDescription: "All services offered by this organization across all wards.",
    availableEntitiesText: "Available wards for this tenant:",
  },
  supermarket: {
    entityPlural: "Branches",
    entitySingular: "Branch",
    ...
    bookingTypeLabel: "Booking Type",
    selectedEntityLabel: "Selected Branch",
    entitySearchPlaceholder: "Search branches...",
    serviceSearchPlaceholder: "Search services...",
    serviceSelectionTitle: "Available Services",
    serviceSelectionDescription: "All services offered by this organization across all branches.",
    availableEntitiesText: "Available branches for this tenant:",
  ...
  police: {
    ...
    myBooking: "My Booking",
    bookingTypeLabel: "Booking Type",
    selectedEntityLabel: "Selected Division",
    entitySearchPlaceholder: "Search divisions...",
    serviceSearchPlaceholder: "Search services...",
    serviceSelectionTitle: "Available Services",
    serviceSelectionDescription: "All services offered by this organization across all divisions.",
    availableEntitiesText: "Available divisions for this tenant:",
  },
  saloon: {
    entityPlural: "Chairs",
    entitySingular: "Chair",
    services: "Services",
    bookToken: "Get Token",
    queueStatus: "Queue Status",
    notifications: "Notifications",
    myBooking: "My Booking",
    bookingTypeLabel: "Booking Type",
    selectedEntityLabel: "Selected Chair",
    entitySearchPlaceholder: "Search chairs...",
    serviceSearchPlaceholder: "Search services...",
    serviceSelectionTitle: "Available Services",
    serviceSelectionDescription: "All services offered by this organization across all chairs.",
    availableEntitiesText: "Available chairs for this tenant:",
  },
  hotel: {
    entityPlural: "Rooms",
    entitySingular: "Room",
    ...
    myBooking: "My Booking",
    bookingTypeLabel: "Booking Type",
    selectedEntityLabel: "Selected Room",
    entitySearchPlaceholder: "Search rooms...",
    serviceSearchPlaceholder: "Search services...",
    serviceSelectionTitle: "Available Services",
    serviceSelectionDescription: "All services offered by this organization across all rooms.",
    availableEntitiesText: "Available rooms for this tenant:",
  },
};
...
export const tenantConfig = {
  ...
  supermarket: {
    ...
    bookingType: "token",
    labels: tenantLabels.supermarket,
    organizations: [
      {
        name: "Keells",
        branches: ["Colombo Branch", "Kandy Branch", "Galle Branch"],
